...
import 'package:cabu_cabu_user_mobile/src/features/ride_booking/presentation/screens/book_verified_ride_screen.dart';
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        ...
        child: ElevatedButton(
          onPressed: () => context.push(BookVerifiedRideScreen()),
