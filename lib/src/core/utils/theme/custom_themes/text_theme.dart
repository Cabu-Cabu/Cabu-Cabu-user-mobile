...
class AppTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
      ...
      bodyLarge: const TextStyle().copyWith(
          fontSize: 15.0.sp, fontWeight: FontWeight.w400, color: Colors.black),
      ...
      labelLarge: const TextStyle().copyWith(
          fontSize: 12.0.sp, fontWeight: FontWeight.w400, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
      ...
      titleMedium: const TextStyle().copyWith(
          fontSize: 16.0.sp, fontWeight: FontWeight.w500, color: Colors.white),
      titleSmall: const TextStyle().copyWith(
          fontSize: 16.0.sp, fontWeight: FontWeight.w400, color: Colors.white),
      bodyLarge: const TextStyle().copyWith(
          fontSize: 14.0.sp, fontWeight: FontWeight.w500, color: Colors.white),
      bodyMedium: const TextStyle().copyWith(
          fontSize: 14.0.sp, fontWeight: FontWeight.w400, color: Colors.white),
      bodySmall: const TextStyle().copyWith(
          fontSize: 14.0.sp,
          fontWeight: FontWeight.w500,
          color: Colors.white.withOpacity(0.5)),
      labelLarge: const TextStyle().copyWith(
          fontSize: 12.0.sp, fontWeight: FontWeight.w400, color: Colors.white),
      labelMedium: const TextStyle().copyWith(
          fontSize: 12.0.sp,
          fontWeight: FontWeight.w400,
          color: Colors.white.withOpacity(0.5)));
